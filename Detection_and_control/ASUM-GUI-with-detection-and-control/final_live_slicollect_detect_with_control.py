...
def cv2_demo(net, transform):
    ...
    det_out = cv2.VideoWriter('/media/lwz/BCF60E29F60DE50C/20190321-out_det_real_experiment-final_automotorspeed-slice800nm-newknife.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 35, (frame_width, frame_height))
